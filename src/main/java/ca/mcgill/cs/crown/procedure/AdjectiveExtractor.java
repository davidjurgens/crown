 ...
 */
public class AdjectiveExtractor implements EnrichmentProcedure {
    ...
    public AdjectiveExtractor(IDictionary dict,
    ...
    public AnnotatedLexicalEntry integrate(LexicalEntry e) {
        ...
        // First check that this sense isn't in WN.  Adding new senses to
        // existing adjectives seems to be a bit noisier than we'd like
        if (WordNetUtils.isInWn(dict, e.getLemma(), POS.ADJECTIVE))
            return null;        
